...
<div class="row">
	<div class="col-md-4">
		...
		<input type="text" class="input-sm form-control" name="onsearch" id="onsearch" placeholder=".. Type and Enter for Search .." />
	</div>
	...
	<div class="col-md-8 pull-right text-right">
			@foreach( $actions as $key=> $val)
				...
				@else
				<a href="javascript:void(0)" class="btn btn-default btn-sm ajaxCallback" code="{{ $key }}" mode="native"><i class="{{ $val['icon'] }}"></i> </a>
				@endif
			@endforeach
