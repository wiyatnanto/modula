                    ...
                    @for ($i = 1; $i <= 5; $i++)
                        <div class="col-6 col-sm">
                            <div class="mg-b-30 @error('images.' . $i) is-invalid @enderror">
                                <div wire:ignore x-data="{ images: @entangle('images.' . $i) }" x-init="() => {
    ...
    <x-crud::molecules.card class="mt-3">
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                ...
                <p>Kamu dapat menambah brand baru atau memilih dari daftar brand yang ada {{ $brand }}
                </p>
            </div>
            <div class="col-md-8">
                <div wire:ignore>
                    <div x-data="{ selected: @entangle('brand') }" x-init="() => {
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-8">
                ...
                {{-- custom --}}
                <div wire:ignore>
                    <div x-data="{ selected: @entangle('category') }" x-init="() => {
                        select = $($refs.select).select2({
