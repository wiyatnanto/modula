    ...
    <div class="tab-pane fade show active" id="config" role="tabpanel" aria-labelledby="profile-line-tab">
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        @include('crud::builder.tab',array('active'=>'table','type'=>$type))
                        {!! Form::open(array('url'=>'crud/builder/savetable/'.$name, 'class'=>'form-horizontal','id'=>'crudtable')) !!}
                            ...
                            <tbody class="no-border-x no-border-y">
                                ...
                                <tr>
                                    ...
                                    <td><strong><?php echo $rows['field'];?></strong>
                                        <input type="hidden" name="field[<?php echo $id;?>]" id="field" value="<?php echo $rows['alias'];?>" />
                                    </td>
                                    ...
                                    <td>
                                    		<div class="input-group">
																				  ...
																				  <input name="label[<?php echo $id;?>]" type="text" class="form-control form-control-sm " id="label" value="<?php echo $rows['label'];?>" aria-describedby="basic-addon1">
																				</div>
                                    </td>
                                    <td>
                                    	<div class="form-check">
																			    <input type="checkbox" class="form-check-input" id="checkChecked" name="view[<?php echo $id;?>]" type="checkbox" id="view" value="1" class="minimal-green" <?php if($rows['view'] == 1) echo 'checked="checked"';?> />
                                    ...
                                    <td>
                                    	<div class="form-check">
																			    <input type="checkbox" class="form-check-input" id="checkChecked" name="detail[<?php echo $id;?>]" type="checkbox" id="detail" value="1" class="minimal-green" <?php if($rows['detail'] == 1) echo 'checked="checked"';?> />
																			    <label class="form-check-label" for="checkChecked">
                                    ...
                                    <td>
                                    	<div class="form-check">
																			    <input type="checkbox" class="form-check-input" id="checkChecked" name="sortable[<?php echo $id;?>]" type="checkbox" id="sortable" value="1" class="minimal-green" <?php if($rows['sortable'] == 1) echo 'checked="checked"';?> />
																			    <label class="form-check-label" for="checkChecked">
                                    ...
                                    <td>
                                    	<div class="form-check">
																			    <input type="checkbox" class="form-check-input" id="checkChecked" name="download[<?php echo $id;?>]" type="checkbox" id="download" value="1" class="minimal-green" <?php if($rows['download'] == 1) echo 'checked="checked"';?> />
																			    <label class="form-check-label" for="checkChecked">
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <div class="input-group-btn">
                                                ...
                                                <ul class="dropdown-menu format-option">
                                                    ...
                                                    <a class="dropdown-item" href="javascript://void" code="{{ $val['placeholder'] }}" value="{{ $key }}" onid="{{ $id }}">{{ $val['name'] }}</a>
                                                    @endforeach
                                                    <a class="dropdown-item" href="javascript://void" value="Format" code="Unformated" onid="{{$id}}"> Format </a>
                                                </ul>
                                            </div><!-- /btn-group -->
                                            <input type="text" name="format_value[<?php echo $id;?>]" id="format_value-{{$id}}" value="<?php if(isset($rows['format_value'])) echo $rows['format_value'];?>" class="form-control form-control-sm" placeholder="Unformated">
                                        ...
                                        <input type="hidden" name="conn_valid[<?php echo $id;?>]" value="<?php if(isset($rows['conn']['valid'])) echo $rows['conn']['valid'];?>" />
                                        <input type="hidden" name="conn_db[<?php echo $id;?>]" value="<?php if(isset($rows['conn']['db'])) echo $rows['conn']['db'];?>" />
                                        <input type="hidden" name="conn_key[<?php echo $id;?>]" value="<?php if(isset($rows['conn']['key'])) echo  $rows['conn']['key'];?>" />
                                        <input type="hidden" name="conn_display[<?php echo $id;?>]" value="<?php if(isset($rows['conn']['display'])) echo   $rows['conn']['display'];?>" />
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        ...
                        <button type="submit" class="btn btn-xs btn-primary btn-icon-text">Save Changes <i class="btn-icon-append" data-feather="save"></i></button>
