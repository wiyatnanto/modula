...
class Table extends Component
{
    ...
    public $postId, $title, $content, $slug, $status, $featured_image, $caption, $published_at, $user_id;
    public $category;
    public $tags = [];
    ...
    public function edit($id)
    {
        ...
        $this->tags = $post->Tags()->get()->pluck('name')->toArray();
    }
