...
@section('content')
  ...
  <div class="panel-default panel">
    ...
    <ul class="parsley-error-list">
     ...
     {!! Form::open(array('url'=>'builder/dopackage', 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
          <div class="col-md-6">
              <div class="header" >
                ...
                <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group  " >
                              ...
                              <div class="" >
                                <input type="checkbox" name="file_lang[]" value="{{ $file }}"> <label>{!! $file !!} </label>
