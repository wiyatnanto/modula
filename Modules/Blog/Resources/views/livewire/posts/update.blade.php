            ...
            <x-crud::molecules.tab title="Content" name="content">
                <div class="mt-3">
                    ...
                    <div class="mb-3">
                        ...
                        @error('content')
                            <label id="content-error" class="error invalid-feedback"
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="mb-3">
                                ...
                                <x-crud::atoms.select2 name="category" wire:model="category"
                                    dropdownParent="updatePost">
            ...
            <x-crud::molecules.tab title="Meta" name="meta">
                <div class="mt-3">
                    <div class="mb-3">
                        ...
                        @error('meta')
                            <label id="meta-error" class="error invalid-feedback"
                                for="meta">{{ $message }}</label>
                        @enderror
                    </div>
                </div>
            </x-crud::molecules.tab>
