                        ...
                        <tr>
                            <th scope="col" width="50">
                                <label class="custom-control custom-checkbox" wire:key="all">
                                    <input type="checkbox" class="custom-control-input" wire:model="selectAll"
                                        id="selectAll">
                                ...
                                <th scope="col">Info Produk
                                    ...
                                    @else
                                        <img wire:click="sortBy('name')"
                                            src="{{ asset('modules/store/img/sort.png') }}" width="18"
                                            height="18" alt="Sort">
                                    @endif
                                </th>
                            ...
                            @else
                                <th scope="col" class="tx-bold" colspan="7">
                                    <a href="#" type="button" class="btn btn-xs btn-outline-danger"
                                        id="trash-all-product">
                    ...
                    @if (count($products) > 0)
                        @foreach ($products as $key => $product)
                            <tr>
                                <td>
                                    ...
                                    <label class="custom-control custom-checkbox select mt-2"
                                        ...
                                        <input type="checkbox" class="custom-control-input"
                                            data-id="{{ $product->id }}" wire:model="selected.{{ $product->id }}">
                                        <span class="custom-control-label"></span>
                                    </label>
                                </td>
                                <td>
                                ...
                                <td>
                                    <h6 class="tx-spacing-1 tx-12 tx-grey-600 mg-b-5" data-toggle="tooltip"
                                        data-placement="top" title="Dalam Pengembangan">Skor: Sempurna</h6>
                                    <div class="progress bg-transparent wd-100 op-7 ht-10 mg-b-15 mg-r-20"
                                        ...
                                        <div class="progress-bar bg-primary wd-20p bd-l bd-white" role="progressbar"
                                            aria-valuenow="20" aria-valuemin="0" aria-valuemax="20"></div>
                                        <div class="progress-bar bg-primary wd-20p bd-l bd-white" role="progressbar"
                                            aria-valuenow="20" aria-valuemin="0" aria-valuemax="20"></div>
                                        <div class="progress-bar bg-primary wd-20p bd-l bd-white" role="progressbar"
                                            aria-valuenow="20" aria-valuemin="0" aria-valuemax="20"></div>
                                        <div class="progress-bar bg-gray-300 wd-20p bd-l bd-white" role="progressbar"
                                            aria-valuenow="20" aria-valuemin="0" aria-valuemax="20"></div>
                                    </div>
                                    <span class="tx-13 tx-gray-700" data-toggle="tooltip" data-placement="top"
                                ...
                                <td>
                                    <div class="custom-control custom-switch mg-t-15">
                                        <input wire:click="toggleActive({{ $product->id }})" type="checkbox"
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a class="dropdown-item" type="button"><i class="fas fa-clone"></i>
                                                Duplikat Produk</a>
                                            <a class="dropdown-item trash-product" data-name="{{ $product->name }}"
