<x-crud::organisms.modal id="updatePermission">
    ...
    <div class="mb-3">
        ...
        <x-crud::atoms.input type="text" placeholder="Permission Name" name="name" wire:model="name" />
        @error('name')
    ...
    <x-slot name="footer">
        ...
        <x-crud::atoms.button size="sm" color="primary" wire:click.prevent="update({{ $permissionId }})"
            text="Update" />
    </x-slot>
