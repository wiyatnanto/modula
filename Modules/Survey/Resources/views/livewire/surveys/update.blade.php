<x-crud::organisms.modal preventSubmit="update({{ $surveyId }})" submitLabel="Update" id="updateSurvey"
    title="Update Survey">
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <x-crud::atoms.filepond placeholder="Background Image" name="bg_header" loadFile="{{ $bg_header }}"
            wire:model="bg_header" />
        @error('bg_header')
